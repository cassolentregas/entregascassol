// service-worker.js (VERSÃO FINAL E CORRIGIDA)

// Link do Dexie corrigido para jsdelivr, que não usa redirecionamento
importScripts('https://cdn.jsdelivr.net/npm/dexie@3/dist/dexie.js');
importScripts('https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2');

// --- CONFIGURAÇÃO ---
const CACHE_NAME = 'comprovante-entrega-cache-v-final-1';
const urlsToCache = [ '/', '/index.html', '/manifest.json' ];

// Confirme que estas chaves são as mesmas do seu index.html
const SUPABASE_URL = 'https://sdwmjiohhkmfdbvypshg.supabase.co'; 
const SUPABASE_KEY = 'eyJhbGciOiJIzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNkd21qaW9oaGttZmRidnlwc2hnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTk3OTU2MjgsImV4cCI6MjA3NTM3MTYyOH0.IPBHlwiidD-w710Tk0SAA_zfEwR8jlX_adoICRSkqBY';
